...
// CATEGORIAS_CATALOGO debe estar coordinado con las categorías disponibles en admin
// Ejemplo de estructura coordinada:
export const CATEGORIAS_CATALOGO = {
  ...
  ropa: [
    ...
    { valor: 'pitufo', etiqueta: 'Pitufo', emoji: '🧑‍🎤' }, // Nueva categoría agregada
  ],
  perfumes: [
    { valor: 'todos', etiqueta: 'Todo', emoji: '🧴' },
    { valor: 'originales', etiqueta: 'Originales', emoji: '🌟' },
    { valor: 'alternativos', etiqueta: 'Alternativos', emoji: '✨' },
    { valor: 'general', etiqueta: 'General', emoji: '🧴' },
  ],
  juguetes: [
    { valor: 'todos', etiqueta: 'Todo', emoji: '🧸' },
    { valor: 'didacticos', etiqueta: 'Didácticos', emoji: '🎲' },
    { valor: 'peluches', etiqueta: 'Peluches', emoji: '🧸' },
    { valor: 'general', etiqueta: 'General', emoji: '🎁' },
  ]
}

// CATEGORIAS_ROPA debe estar coordinado con las categorías disponibles en admin
// Ejemplo de estructura coordinada:
...
// Colores de prenda para Ropa
import { COLORES_ROPA } from '@/lib/constantes'
...
export default function PaginaCatalogo() {
  ...
  const productosFiltrados = productos
    .filter(p => {
      ...
      // Filtro por categoría (usando solo las categorías coordinadas)
